    ...
    <div className="w-full space-y-6 pb-10">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <form onSubmit={handleSubmit} className="divide-y divide-gray-100">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm bg-gray-50 flex items-center h-[42px] overflow-hidden">
                  <FileBase
                    type="file"
                    multiple={false}
              ...
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-700">Father's Contact <span className="text-red-500">*</span></label>
                <input
                  type="number"
                  required
              ...
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-700">Mother's Contact <span className="text-red-500">*</span></label>
                <input
                  type="number"
                  required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full rounded-lg border-gray-300 border px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-600 focus:border-blue-600 outline-none transition-all bg-gray-100 text-gray-600 cursor-not-allowed"
                >
              ...
              {/* Batch */}
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-700">Batch <span className="text-red-500">*</span></label>
                <input
                  type="text"
                  required
                  value={value.batch}
          ...
          {/* Footer Actions */}
          <div className="p-6 sm:p-8 bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-4">
             <div className="text-[13px] text-gray-500 max-w-lg">
              <span className="font-semibold text-gray-700">Note:</span> Username is auto-generated (e.g. STU202600100). The initial password is the date of birth in DD-MM-YYYY format.
             </div>
