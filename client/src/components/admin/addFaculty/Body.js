    ...
    <div className="w-full space-y-6 pb-10">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <form onSubmit={handleSubmit} className="divide-y divide-gray-100">
          ...
          {/* Academic Assignment */}
          <div className="p-6 sm:p-8 space-y-6">
            <h2 className="text-lg font-semibold text-gray-900">Academic Assignment</h2>
          ...
          <div className="p-6 sm:p-8 bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-4">
             <div className="text-[13px] text-gray-500 max-w-lg">
              <span className="font-semibold text-gray-700">Note:</span> Username is auto-generated (e.g. FAC202600100). The initial password is the date of birth in DD-MM-YYYY format.
             </div>
