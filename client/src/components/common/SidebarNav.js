...
const isNotActiveStyle = `${linkBase} text-slate-600 hover:bg-slate-50 hover:text-slate-900`;
const isActiveStyle = `${linkBase} bg-indigo-50 text-indigo-700 font-semibold shadow-sm ring-1 ring-indigo-500/10`;
